                                ...
                                <div class="col s9 z-depth-2">
                                  <div class="row z-depth-1 workorderRow">
                                        <div class="col 12 formargin worept z-depth-0">
                                            <h5>Create Work Order Report</h5>
                                            <form action="reportModel.php" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row formRow">
                                                    <div class="input-field col s12">
                                                        ...
                                                        <p>
                                                            <label>
                                                                <input type="radio" id="" name="addressVarification" value="YES" />
                                                                <span>YES</span>
                                                            </label>
                                                            <label>
                                                                <input type="radio" id="" name="addressVarification" value="NO" />
                                                                <span>NO</span>
                                                            </label>
                                                        </p>
                                                    </div>
                                                ...
                                                <div class="row formRow">
                                                    <div class="input-field col s12">
                                                        ...
                                                        <input type="text" name="yearlySales" id="yearlySales" class="validate"   required>
                                                    </div>
                                                ...
                                                <div class="row formRow">
                                                    <div class="input-field col s12">
                                                        ...
                                                        <input type="text" name="inventoryAmount" id="inventoryAmount" class="validate"   required>
                                                    </div>
                                                ...
                                                <div class="row formRow">
                                                    <div class="input-field col s12">
                                                        <h5>LOI Varified (Self Empolyed or Salaried Person)</h5>
                                                            <p>
                                                                <label>
                                                                    <input type="radio" id="" name="loiVarification" value="YES" />
                                                                    <span>YES</span>
                                                                </label>
                                                                <label>
                                                                    <input type="radio" id="" name="loiVarification" value="NO" />
                                                                    <span>NO</span>
                                                                </label>
                                                            </p>
                                                    </div>
                                                ...
                                                <div class="row formRow">
                                                    <div class="file-field input-field col s12">
                                                        <div class="btn">
                                                            <span>File</span>
                                                            <input type="file" id="" name="reportfile" value="" required>
                                                        </div>
                                                        <div class="file-path-wrapper">
                                                            <input class="file-path validate" type="text" placeholder="Attatched Importent Document">
                                                        </div>   
                                                    </div>
                                                ...
                                                <div class="row formRow">
                                                    <div class="file-field input-field col s12">
                                                        ...
                                                        <textarea id="icon_prefix2" class="materialize-textarea" name="reportComment"></textarea>
                                                    </div>
