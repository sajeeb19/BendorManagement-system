...
if(isset($_GET)){
    ...
    $spl1= "SELECT * FROM workorder_report WHERE assigentById= $id " ;
                                                ...
                                                <table>
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Address Varified: <?php echo " ". htmlspecialchars($item['addressVarification']) ; ?> </td>
                                                            
                                                                                                                           
                                                            <td>Yearly Sales Turn Over:<?php echo " ". htmlspecialchars($item['yearlySales']) ; ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                        </div>
                                        <div class="col s2  center"> 
                                            <!-- <a href="reportUpdate.php?id=<?php echo $employinfo['employId']?> & wonumber=<?php echo urldecode($item['workOrderId'])  ?> " class=" "><i class=" medium material-icons  hoverable  foricon "> edit </i></a> -->
                                            <!-- <a class="btn pulse"><i class="material-icons foricon">menu</i></a> -->
                                    
                                         </div>
                                        <div class="col s2 center">
                                            <a href="reportView.php?id=<?php echo $employinfo['employId']?> & wonumber=<?php echo urldecode($item['workOrderId'])  ?> " class=" "><i class=" medium material-icons  hoverable  foricon "> view_module</i></a>                                         
                                        </div>
                                   </div>                               
                                 <?php endforeach; ?>
                                </div>
